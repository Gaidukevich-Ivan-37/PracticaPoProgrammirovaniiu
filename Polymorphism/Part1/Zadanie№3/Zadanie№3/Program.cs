    ...
    class Program
    {
        static void Main()
        {
            Console.WriteLine("Задание №3\n Составить программу с одним родительским классом и двумя потомками. " +
                ...
                "\n на объекты базового и производных классов (количество объектов >= 5). Родительский класс: населённый пункт (поле название). " +
                "\n Потомки: офис (поле - количество этажей N), завод (поле - вес G). Организовать вычисление средней стоимости офиса и завода. \n\nРешение:");
            ...
            double HO = ho / kol;
            Console.WriteLine("\n Средняя высота офиса: {0}", HO);

            double HF = hf / kol;
            Console.WriteLine(" Средняя высота завода: {0}", HF);
